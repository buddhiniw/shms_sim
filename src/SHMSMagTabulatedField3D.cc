...
{    
  ...
  // using the center of the HB as the origin. Therefore, we need to rotate the
  // bfields locations in the map to get their location in the global coordinate system.
  // 
